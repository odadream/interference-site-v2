        ...
        <div className={`flex flex-col ${s.gapSm} ${s.mbLg}`}>
            ...
            {mosaicPhotos.map((photo) => {
              ...
              return (
                <button
                  ...
                  className={`relative group overflow-hidden cursor-zoom-in text-left border border-border-faint hover:border-accent-primary/40 transition-colors duration-300 ${sizeClasses[photo.size] ?? 'col-span-1 row-span-1'}`}
                >
                  <img
          ...
          {closingPhoto && (
            <button
              ...
              className="relative group overflow-hidden cursor-zoom-in text-left w-full border border-border-faint hover:border-accent-primary/40 transition-colors duration-300"
            >
              <img
